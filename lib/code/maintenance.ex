defmodule Code.Maintenance do
  ...
  @registry Code.MaintenanceRegistry
  @supervisor Code.MaintenanceSupervisor
  ...
  defp start_job(key, job, overrides) do
    DynamicSupervisor.start_child(
      @supervisor,
      {Code.Maintenance.Job, {self(), key, job.mode, overrides}}
    )
  end
...
defmodule Code.Maintenance.Job do
  @moduledoc false

  use GenServer

  alias Code.Config
  alias Code.Maintenance.Lookup
  alias Code.Replica.Compactor

  @registry Code.MaintenanceRegistry

  @spec child_spec({pid(), {String.t(), Code.Maintenance.kind()}, Code.Maintenance.mode(), map()}) ::
  ...
  @spec start_link({pid(), {String.t(), Code.Maintenance.kind()}, Code.Maintenance.mode(), map()}) ::
          GenServer.on_start()
...
defmodule Code.Maintenance.Lookup do
  @moduledoc """
  ...
  @spec run(String.t(), Code.Maintenance.mode()) :: {:ok, map()} | {:error, term()} | :not_due
