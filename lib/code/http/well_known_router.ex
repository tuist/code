defmodule Code.HTTP.WellKnownRouter do
  @moduledoc """
  OAuth 2.1 protected-resource metadata.

  Code is a resource server: it validates tokens and never issues them. This
  ...
  against Code — the confused-deputy problem the MCP authorization spec
  exists to prevent.
  """
  ...
  get "/oauth-protected-resource" do
    send_json(conn, %{
      resource: Code.Config.resource_identifier(),
      authorization_servers: Code.Config.authorization_servers(),
      bearer_methods_supported: ["header"],
      scopes_supported: ["read", "write", "admin"],
      resource_documentation: "https://github.com/tuist/code/blob/main/docs/mcp.md"
    })
  end
  ...
  get "/code-git-auth" do
    case Code.Config.git_auth() do
      nil ->
        send_resp(conn, 404, "")
