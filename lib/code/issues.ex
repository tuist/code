defmodule Code.Issues do
  @moduledoc """
  Repository issues stored in a private Git reference.

  The source repository's `refs/code/issues` reference is part of the same
  ...
  defp system_author, do: %{name: "Code", email: "issues@code.local"}
