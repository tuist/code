defmodule Code.Auth.WebhookTest do
  @moduledoc """
  ...
  setup do
    ...
    if is_nil(Process.whereis(Code.Auth.Webhook.Cache)) and
         :ets.whereis(Code.Auth.Webhook.Cache) == :undefined do
  ...
  describe "cache hygiene" do
    ...
    test "an expired entry is deleted rather than left behind" do
      ...
      before = :ets.info(Code.Auth.Webhook.Cache, :size)
      ...
      assert :ets.info(Code.Auth.Webhook.Cache, :size) <= before + 1,
