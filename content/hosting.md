...
Code runs as an ordinary Kubernetes Deployment, not a stateful set. The
...
These deployment flows configure one Code node, expose it on port `4000`,
...
<div class="deploy-buttons">
  <a href="https://render.com/deploy?repo=https%3A%2F%2Fgithub.com%2Ftuist%2Fcode" aria-label="Deploy Code on Render">
    <img src="https://render.com/images/deploy-to-render-button.svg" alt="Deploy to Render">
  </a>
  <a href="https://cloud.digitalocean.com/apps/new?repo=https://github.com/tuist/code/tree/main" aria-label="Deploy Code on DigitalOcean App Platform">
    <img src="https://www.deploytodo.com/do-btn-blue.svg" alt="Deploy to DigitalOcean">
  </a>
  <a href="https://www.heroku.com/deploy?template=https://github.com/tuist/code/tree/main" aria-label="Deploy Code on Heroku">
...
key. They also request `CODE_AUTH_TOKENS`, using the format
...
Heroku builds the repository Dockerfile. Azure deploys the published Code
...
Code validates tokens but never issues them. In Kubernetes, the easiest path
...
For people and external services, point Code at your existing OpenID Connect
issuer. You can also grant read or write patterns from an account policy in the
same object store as the log.

The [chart values](https://github.com/tuist/code/blob/main/charts/code/values.yaml)
and [authentication reference](https://github.com/tuist/code/blob/main/docs/multi-tenancy.md)
